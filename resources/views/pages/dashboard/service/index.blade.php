...
@section('content')
                    ...
                    <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <span class="ml-1 text-gray-400 md:ml-2 dark:text-gray-500" aria-current="page">Layanan</span>
                            </div>
                        </li>
                    </ol>
                </nav>
    ...
    @include('pages.dashboard.service.add-form')

    @foreach ($service as $data)
        @include('pages.dashboard.service.detail', ['data' => $data])
        @include('pages.dashboard.general.delete', ['data' => $data, 'url' => route('dashboard.service.destroy', ['id' => $data->id])])
    @endforeach
@endsection
