        ...
        <div class="w-full mb-1">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <span class="ml-1 text-gray-400 md:ml-2 dark:text-gray-500"
                                    aria-current="page">Profile</span>
                            </div>
                        </li>
                    </ol>
                </nav>
            ...
            <div class="">
                <form action="{{ route('dashboard.profile.update') }}" method="POST">
                    ...
                    <div class="w-full md:w-1/2">
                        <label for="phone"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nomor Telephone/Whatsapp</label>
                        <div class="flex mb-6">
                            <span
                                class="inline-flex items-center px-3 text-sm text-gray-900 bg-gray-200 border rounded-e-0 border-gray-300 border-e-0 rounded-s-md dark:bg-gray-600 dark:text-gray-400 dark:border-gray-600">
                    ...
                    <div class="w-full md:w-1/2">
                        <label for="password" class="block font-medium text-gray-900 dark:text-white">Password</label>
                        <p class="mb-2 text-sm text-gray-400">(Kosongkan jika tidak ingin mengganti password)</p>
                        <div class="flex mb-6">
                            <span
                                class="inline-flex items-center px-3 text-sm text-gray-900 bg-gray-200 border rounded-e-0 border-gray-300 border-e-0 rounded-s-md dark:bg-gray-600 dark:text-gray-400 dark:border-gray-600">
                    ...
                    <div class="w-full md:w-1/2">
                        <button type="submit"
                            class="w-full text-white bg-customprimary-600 hover:bg-customprimary-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:bg-customprimary-600 dark:hover:bg-customprimary-700 dark:focus:ring-blue-800">
                            Simpan
                        </button>
                    </div>
                </form>
