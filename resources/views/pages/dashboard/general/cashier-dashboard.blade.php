    ...
    <div class="p-4 pb-10 bg-white lg:mt-1.5 dark:bg-gray-800 shadow">
        ...
        <div class="grid w-full grid-cols-1 gap-5 mt-4 lg:grid-cols-3">
            <div
                ...
                <div class="w-full text-center sm:text-left">
                    <h3 class="text-xl font-bold text-white ">Total Customer</h3>
            ...
            <div
                ...
                <div class="w-full text-center sm:text-left">
                    <h3 class="text-xl font-bold text-white ">Total Pesanan</h3>
                    <p class="text-xl font-bold leading-none text-white sm:text-2xl">
                        {{ $data->orderCount }}</p>
                </div>
            </div>
            ...
            <div
                class="flex flex-col  items-center justify-center p-4 bg-sky-600 border border-gray-200 rounded-lg shadow-md sm:flex-row sm:p-6 dark:border-gray-700 hover:shadow-lg transition-shadow duration-300">
                <span class="text-white text-6xl md:mr-3 mr-0 ">
                    <span class="iconify" data-icon="clarity:clipboard-solid" data-inline="false"></span>
                </span>
                <div class="w-full text-center sm:text-left">
                    <h3 class="text-xl font-bold text-white ">Total Pesanan Aktif</h3>
                    <p class="text-xl font-bold leading-none text-white sm:text-2xl">
                        {{ $data->activeOrderCount }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="grid w-full grid-cols-1 gap-y-5 lg:gap-x-5 mt-5 lg:grid-cols-3">
            <div
                ...
                <div class="w-full text-center sm:text-left">
                    <h3 class="text-xl font-bold text-white ">Customer Hari Ini</h3>
                    <p class="text-xl font-bold leading-none text-white sm:text-2xl">
                        {{ $data->customerTodayCount }}</p>
                </div>
            </div>

            <div
                class="flex flex-col  items-center justify-center p-4 bg-gray-500 border border-gray-200 rounded-lg shadow-md sm:flex-row sm:p-6 dark:border-gray-700 hover:shadow-lg transition-shadow duration-300">
                <span class="text-white text-6xl md:mr-3 mr-0 ">
                    <span class="iconify" data-icon="clarity:clipboard-solid" data-inline="false"></span>
                </span>
                <div class="w-full text-center sm:text-left">
                    <h3 class="text-xl font-bold text-white ">Pesanan Hari Ini</h3>
                    <p class="text-xl font-bold leading-none text-white sm:text-2xl">
                        {{ $data->orderTodayCount }}</p>
                </div>
            </div>
            ...
            <div
                ...
                <div class="w-full text-center sm:text-left">
                    <h3 class="text-xl font-bold text-white ">Pemasukan Hari Ini</h3>
                    <p class="text-xl font-bold leading-none text-white sm:text-2xl">
                        Rp {{ number_format($data->sumIncomeThisDay, 0, ',', '.') }}</p>
                </div>
            </div>
        </div>
