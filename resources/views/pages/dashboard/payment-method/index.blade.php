...
@section('content')
                    ...
                    <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <span class="ml-1 text-gray-400 md:ml-2 dark:text-gray-500" aria-current="page">Metode Pembayaran</span>
                            </div>
                        </li>
                    </ol>
                </nav>
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Data Metode Pembayaran</h1>
            </div>
            <div class="flex">
    ...
    <div class="flex flex-col shadow">
        ...
        <div
            ...
            <div class="flex items-center space-x-3">
                ...
                <a @if ($payment_method->lastPage() !== $payment_method->currentPage()) href="{{ $payment_method->nextPageUrl() }}" @endif
                    class="@if ($payment_method->lastPage() === $payment_method->currentPage()) cursor-not-allowed @endif inline-flex items-center justify-center flex-1 px-3 py-2 text-xs font-medium text-center text-customprimary-700 border border-customprimary-700 rounded-lg hover:text-white hover:bg-customprimary-700 focus:ring-4 focus:ring-customprimary-300 dark:bg-customprimary-600 dark:hover:bg-customprimary-700 dark:focus:ring-customprimary-800 dark:text-white">
                    Berikutnya
    ...
    @include('pages.dashboard.payment-method.add-form')

    @foreach ($payment_method as $data)
        @include('pages.dashboard.payment-method.detail', ['data' => $data])
        @include('pages.dashboard.general.delete', ['data' => $data, 'url' => route('dashboard.payment-method.destroy', ['id' => $data->id])])
    @endforeach
@endsection
