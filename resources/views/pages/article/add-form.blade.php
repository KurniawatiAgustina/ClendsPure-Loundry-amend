            ...
            <form action="{{ route('dashboard.article.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="p-6 space-y-6 max-h-96 overflow-y-auto [&::-webkit-scrollbar]:w-1 [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500">
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-1">
                        ...
                        <div>
                            <label for="content"
                                class="block text-sm font-medium text-gray-700 dark:text-gray-300">Isi Konten</label>
                            <textarea name="content" id="content" class="block w-full mt-1 text-sm border-gray-300 rounded-md shadow-sm dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white focus:ring-customprimary-500 focus:border-customprimary-500"></textarea>
                        </div>
                        <div>
