...
<li>
    <button type="button"
        class="flex items-center w-full p-2 text-base transition duration-75 rounded-lg group hover:bg-customprimary-500 hover:text-white hover:font-semibold dark:hover:bg-gray-700
