        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start">
                ...
                <a href="{{ url('/') }}" class="flex ml-2 md:mr-24">
                    ...
                    <span
                        class="self-center text-xl font-bold sm:text-2xl whitespace-nowrap text-customprimary-500 dark:text-white">Cleds</span>
                </a>
            </div>
                    ...
                    <div>
                        <button type="button"
                            ...
                            <img class="w-10 h-10 rounded-full"
                                src="https://api.dicebear.com/9.x/initials/svg?seed={{ auth()->user()->name }}&backgroundColor=ff9000"
                                alt="avatar" />
                        </button>
                    </div>
                    <!-- Dropdown menu -->
